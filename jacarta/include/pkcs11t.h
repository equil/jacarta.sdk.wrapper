...
#define CKR_ERROR_INTEGRITY					  0x80000010	
...
/**
Параметры для механизма CKM_UEK_DERIVE
*/
typedef struct CK_UEK_DERIVE_PARAMS 
{
  CK_BYTE_PTR pR; // указатель на диверсифицируещее значение
  CK_ULONG ulRLen;
  CK_BYTE_PTR pHashParams; // параметры рассчета хэш значения
  CK_ULONG ulHashParamsLen;
